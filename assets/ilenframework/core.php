...
if ( !class_exists('ilen_framework_1_5_1') ) {


class ilen_framework_1_5_1 {
			...
			<form action="" method="POST" name="frmsave" id="frmsave">
				...
				<div id="poststuff" class="metabox-holder has-right-sidebar">
					...
					<header>
						...
						<?php if( $this->parameter['wp_review'] ): ?><a href="<?php echo $this->parameter['wp_review'] ?>" class="leave-a-review ibtn btnred right rippler rippler-default"><span><i class="fa fa-star"></i></span>Leave a review</a><?php endif; ?>
						<?php if( $this->parameter['twitter'] ): ?><a href="<?php echo $this->parameter['twitter'] ?>" class="tweet-about-it ibtn btnturke right rippler rippler-default"><span><i class="fa fa-twitter"></i></span>Write your experience</a><?php endif; ?>
					</header>
