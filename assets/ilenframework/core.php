...
if ( !class_exists('ilen_framework_1_1') ) {


class ilen_framework_1_1 {
	...
	function save_options(){
		...
		if( $_POST && ( $_POST['save_options'] || $_POST['reset_options'] ) && $_POST["name_options"] == $this->parameter["name_option"] ){
