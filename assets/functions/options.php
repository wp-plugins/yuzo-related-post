...
class yuzo_related_post_make{
    ...
    ${'tabs_plugin_' . $this->parameter['name_option']}['tab01']=array('id'=>'tab01','name'=>'Main Settings','icon'=>'<i class="fa fa-circle-o"></i>','width'=>'374'); // 358px = 2 columns
    ${'tabs_plugin_' . $this->parameter['name_option']}['tab02']=array('id'=>'tab02','name'=>'Styling','icon'=>'<i class="fa fa-pencil"></i>','width'=>'374','fix'=>1);
                ...
                'c'=>array(                'title'      => __('Advanced',$this->parameter['name_option']), 
                                           ...
                                           'tab'        => 'tab01',
                                            ...
                                            'options'    => array( 
                                                                    ...
                                                                    array(  'title' =>__('Exclude category:',$this->parameter['name_option']),
                                                                            'help'  =>__('Select a category that does not show in the related.',$this->parameter['name_option']),
                                                                            'type'  =>'checkbox', 
                                                                            'value' =>array('post'),
                                                                            'value_check'=>array('post'),
                                                                            'display'   =>'list', 
                                                                            'items' => $categories_array,
                                                                            'id'    =>$this->parameter['name_option'].'_'.'exclude_category',
                                                                            'name'  =>$this->parameter['name_option'].'_'.'exclude_category',
                                                                            'class' =>'',
                                                                            'row'   =>array('a','b')),
