		...
		$this->options = array('a'=>array(	'title'	 	 => __('Display Options',$this->parameter['name_option']), 		//title section
											...
											'options'	 => array(  
																	...
																	array(	'title'	=>__('Top Text',$this->parameter['name_option']),
																	 		'help' 	=>'Mensaje en la parte superior',
																	 		'type' 	=>'text',
																	...
																	array(	'title'	=>__('Number of  similar Post to display',$this->parameter['name_option']),
																	 		'help' 	=>'Esto es un texto de prueba Esto es un texto de prueba Esto es un texto de prueba Esto es un texto de prueba Esto es un texto de prueba Esto es un texto de prueba ',
																	 		'type' 	=>'select',
																	 		'value'	=>4,
