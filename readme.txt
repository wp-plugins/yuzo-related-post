...
* You can put the <code><?php if ( function_exists( "get_Yuzo_Views" ) ) { get_Yuzo_Views(); } ?></code> function to get the total view of your post, that you can put in your single.php file anywhere you  want and with the personalization you want since this function will get the number of visits this Post.
= 2.7.2 = 
* Minus fix
= 2.7.1 = 
* Fix core.php
